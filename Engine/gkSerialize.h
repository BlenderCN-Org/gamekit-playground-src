...
public:
	gkMaterialProperties()
		:   m_name(),m_fragmentProgram(),m_vertexProgram(),
	...
	gkString                m_name;
	gkString				m_vertexProgram;
	gkString				m_fragmentProgram;
	bool					m_ignoreBlenderTextures;
	unsigned int            m_mode;
	int                     m_rblend;
	gkColor                 m_diffuse;
	gkColor                 m_specular;
...
public:
	...
	typedef utArray<gkVector3> CurvePoints;
...
public:
	...
	gkFogParams     m_fog;
	// the scene should be rendered using a PBS-System
	bool     m_pbsRequested;
};
