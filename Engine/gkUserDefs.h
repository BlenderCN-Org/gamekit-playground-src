...
public:
	...
	bool					esctoexit;          // enable esc-key to exit the game
	gkString				injectedLua;        // injected lua-script that gets executed before the game starts
	...
	bool					ignoreLibraries;

#ifdef BLACKBERRY
	screen_context_t*	    _bbScreen;
#endif
