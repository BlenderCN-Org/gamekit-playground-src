...
public:
	...
	void                    _addOgreBone(Ogre::Bone* bone);
	...
	void _applyBoneChildTransform(gkGameObject* gobj);
...
//	typedef utArray<Ogre::Bone*> OgreBones;
//	OgreBones m_ogreBones;


	Ogre::Bone* m_ogrebone;
	gkBone*      m_parent;
	BoneList    m_children;
