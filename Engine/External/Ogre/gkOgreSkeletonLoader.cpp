	...
	:   m_skeleton(skel)
{
	...
	Ogre::SkeletonPtr oskel = mgr.getByName(name).staticCast<Ogre::Skeleton>();
	if (oskel.isNull())
		oskel = mgr.create(name, skel->getGroupName(), true, this).staticCast<Ogre::Skeleton>(); //GK_BUILTIN_GROUP
}
