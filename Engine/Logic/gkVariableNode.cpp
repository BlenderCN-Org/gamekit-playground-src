...
gkVariableNode::gkVariableNode(gkLogicTree* parent, size_t id, const gkString& name):
	gkLogicNode(parent, id,name), m_debug(false), m_prop(0), m_varName("")
{
	ADD_ISOCK(SET, true);
...
VariableOpNode::VariableOpNode(gkLogicTree* parent, size_t id,const gkString& name) :
