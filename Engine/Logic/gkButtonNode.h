...
public:
	...
	gkButtonNode(gkLogicTree* parent, size_t id, const gkString& name="");
...
public:
	...
	gkKeyNode(gkLogicTree* parent, size_t id, const gkString& name="")
		: gkButtonNode(parent, id,name), m_key(KC_NONE)
	{
	}
...
public:
	...
	gkMouseButtonNode(gkLogicTree* parent, size_t id, const gkString& name="")
		: gkButtonNode(parent, id,name), m_button(gkMouse::Left)
	{
	}
