...
public:
	...
	gkVariableNode(gkLogicTree* parent, size_t id, const gkString& name="");
...
public:
	...
	VariableOpNode(gkLogicTree* parent, size_t id,const gkString& name="");
...
public:
	...
	gkVariableGetSetNode(gkLogicTree* parent, size_t id,const gkString& name="")
		: gkLogicNode(parent, id,name),m_prop(0),m_debug(false)
	{
		ADD_ISOCK(SET, T());
		ADD_OSOCK(GET, T());
	}
