...
gkMouseNode::gkMouseNode(gkLogicTree* parent, size_t id, const gkString& name) :
	gkLogicNode(parent, id,name)
{
	ADD_ISOCK_VAR(SCALE_X, 1);
	ADD_ISOCK_VAR(SCALE_Y, 1);
	ADD_OSOCK_VAR(MOTION, false);
	ADD_OSOCK_VAR(REL_X, 0);
	ADD_OSOCK_VAR(REL_Y, 0);
	ADD_OSOCK_VAR(ABS_X, 0);
	ADD_OSOCK_VAR(ABS_Y, 0);
	ADD_OSOCK_VAR(WHEEL, 0);
	ADD_OSOCK_VAR(WHEEL_MOTION, false);
