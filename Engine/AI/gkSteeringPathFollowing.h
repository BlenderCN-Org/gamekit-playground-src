...
public:
	...
	void setNavMesh(PDT_NAV_MESH navMesh, const gkVector3& polyPickExt, int maxPathPolys, gkScalar minimumTurningRadius)
	{
		m_navMesh = navMesh;
...
#endif
	void setNavPath(gkNavPath* navPath) { m_navPath = navPath; }
private:
