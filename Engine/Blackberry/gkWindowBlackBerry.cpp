...
gkWindowBlackBerry::gkWindowBlackBerry()
	:	m_itouch(0), m_forwardEvent(0,m_forwardState),m_iacc(0)
{
}
...
bool gkWindowBlackBerry::setupInput(const gkUserDefs& prefs)
{
	// OIS
	try
	{
		...
		// TODO2: Get rid of this and use eventmanager system
		try{
...
void gkWindowBlackBerry::dispatch(void)
{
	//GK_ASSERT(m_itouch);
...
void gkWindowBlackBerry::process(void)
{
...
void gkWindowBlackBerry::transformInputState(OIS::MultiTouchState& state)
{
...
bool gkWindowBlackBerry::touchPressed(const OIS::MultiTouchEvent& arg)
{
...
bool gkWindowBlackBerry::touchReleased(const OIS::MultiTouchEvent& arg)
{
	gkMouse& data = m_mouse;
...
bool gkWindowBlackBerry::touchMoved(const OIS::MultiTouchEvent& arg)
{
	gkMouse& data = m_mouse;
...
bool gkWindowBlackBerry::axisMoved( const OIS::JoyStickEvent &arg, int axis ){
...
bool gkWindowBlackBerry::touchCancelled(const OIS::MultiTouchEvent& arg)
{
	return true;
}
