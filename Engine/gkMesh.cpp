...
void gkMesh::updateBounds()
{
	...
	Ogre::MeshPtr omesh = mgr.getByName(name).staticCast<Ogre::Mesh>();
...
//void gkMesh::createLOD(bool force)
//{
//	if (force || !m_lodCreated)
//	{
//		Ogre::MeshPtr lodMesh = Ogre::MeshManager::getSingleton().load(getResourceName().getName(), Ogre::ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME);
//		Ogre::ProgressiveMeshGenerator pm;
//		pm.generateAutoconfiguredLodLevels(lodMesh);
//		m_lodCreated = true;
//	} else {
//		gkLogger::write("Mesh has already LOD!",true);
//	}
//}
