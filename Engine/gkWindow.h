...
protected:
	...
	// add additional raw-listeners on OIS
	OIS::MouseListener* m_OISMOUSE_OPT;
    OIS::KeyListener* m_OISKEYBOARD_OPT;
    OIS::JoyStickListener* m_OISJOYSTICK_OPT;
...
public:
    ...
    void _setOISMouseListener(OIS::MouseListener* listener) { m_OISMOUSE_OPT = listener; }
    void _setOISKeyboardListener(OIS::KeyListener* listener) { m_OISKEYBOARD_OPT = listener; }
    void _setOISJoystickListener(OIS::JoyStickListener* listener) { m_OISJOYSTICK_OPT = listener; }
};
