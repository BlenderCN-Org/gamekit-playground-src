...
#endif
#ifdef OGREKIT_USE_LUA
	float luaScript = gkStats::getSingleton().getLastLuaScriptMicroSeconds() / 1000.0f;
#endif
...
#endif
#ifdef OGREKIT_USE_LUA
	vals += Ogre::StringConverter::toString(luaScript, 3, 7, '0', std::ios::fixed) + "ms ";
	vals += Ogre::StringConverter::toString( int(100 * luaScript / swap), 3 ) + "%\n";
#endif
