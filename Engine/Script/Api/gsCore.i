...
// register this function to be called unhandled! vanilla lua
%native(getScreenshotAsString) int native_getScreenshotAsString(lua_State*L);  // registers native_function() with SWIG
...
GS_SCRIPT_NAME(Touch)
GS_SCRIPT_NAME(MessageManager)
