...
public:
	...
	bool execute(bool isHelperThread=false);

	bool isCreatedFromFile() { return m_fromFile; }

	void setFilePath(const gkString& path);
	gkString getFilePath() { return m_filePath;}
