...
public:
	...
	explicit gkVariable(const gkColor& v, const gkString& name = gkStringUtils::BLANK);
	...
	gkString toString() { return m_value.toString(); }
	...
	void setValue(const gkColor& col);
	...
	gkColor      getValueColor(void) const;
