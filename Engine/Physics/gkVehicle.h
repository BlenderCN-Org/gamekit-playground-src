...
class gkDefaultVehicleRaycaster;
...
protected:
	...
	gkDefaultVehicleRaycaster*         m_raycaster;
...
public:
	...
	void setGearBox(gkGearBox* box);

	void setDefaultGearBox();
...
class gkDefaultVehicleRaycaster : public btVehicleRaycaster
{
	btDynamicsWorld*	m_dynamicsWorld;
public:
	gkDefaultVehicleRaycaster(btDynamicsWorld* world,bool useFilter=false,short int collisionMask=255,short int collisionGroup=255)
		:m_dynamicsWorld(world),m_useFilter(useFilter),m_collisionMask(collisionMask),m_collisionGroup(collisionGroup)
	{
	}
