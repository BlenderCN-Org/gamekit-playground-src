...
public:
	...
	bool collides(const Ogre::Ray& ray, gkScalar rayRadius,int filterGroup=btBroadphaseProxy::AllFilter,int filterMask=btBroadphaseProxy::AllFilter);
	...
	gkGameObject* getHitObject() const;

	void setPositiveList(bool isPositive) { m_isPositiveList = isPositive;}
