...
public:
	...
	gkVector3   getLinearFactor(void);
	void		setLinearFactor(const gkVector3& factor);
	gkVector3   getAngularFactor(void);
	void		setAngularFactor(const gkVector3& factor);

	gkVector3	getGravity(void);
	void 		setGravity(const gkVector3& gravity);
