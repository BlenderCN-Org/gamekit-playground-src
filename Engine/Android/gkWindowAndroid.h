...
public:
	...
	void addMultiTouchCallback(OIS::MultiTouchListener* listener);
private:
	...
	typedef utList<OIS::MultiTouchListener*> MultiTouchCallbacks;
	MultiTouchCallbacks m_multiTouchCallbacks;
};
