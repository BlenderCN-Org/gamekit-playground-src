...
function AnimationNode:evaluate()
  ...
  elseif (not enabled and self.playing) then
    ...
    if (self.RESET_ON_STOP) then
      ...
      self.animationObject:stopAnimation(self.ANIM_NAME)
      self.playing = false
