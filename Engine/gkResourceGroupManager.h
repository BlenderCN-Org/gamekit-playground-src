...
//	utArray<gkResourceNameString> m_groups;
	utList<gkResourceNameString> m_groups;
...
public:
	...
	gkString getPathFromResource(const gkString& resourceName,const gkString& resourceGroupName="General");
	...
	GK_INLINE const utList<gkResourceNameString> getResourceGroupList() { return m_groups; }
