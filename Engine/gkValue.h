...
GK_INLINE void gkFromString(const gkString& s, gkColor& v)    { v = Ogre::StringConverter::parseColourValue(s); }
...
GK_INLINE gkString gkToString(const gkColor& v)    { return Ogre::StringConverter::toString(v); }
