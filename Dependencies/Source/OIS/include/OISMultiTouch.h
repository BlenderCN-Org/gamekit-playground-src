...
namespace OIS
{
	...
	*/
	...
	{
	public:
		MultiTouchState() : width(50), height(50), touchType(MT_None), fingerID(-1), tapCount(0), size(0), pressure(0) {};
	...
	*/
	...
	public:
    	...
    	// TODO: Check if that is needed and/or working at all
	...
	protected:
		MultiTouch(const std::string &vendor, bool buffered, int devID, InputManager* creator)
			: Object(vendor, OISMultiTouch, buffered, devID, creator), mListener(0), mWidth(100), mHeight(100) {}
