...
#ifndef SEQFINISHED_H_
#define SEQFINISHED_H_

#include <BNodes/out-src/src-gen/Generated/gkGamekit.h>
#include <BNodes/out-src/src-nodes/NodesImpl/gkSequenceImpl.h>
// gkSeqFinishedImpl

class gkSeqFinishedImpl
		: public gkSeqFinishedAbstract, public gkSequenceImpl::gkSequenceBrick
{
public:
	gkSeqFinishedImpl(gkLogicTree* parent, size_t id, const gkString& name="");
	virtual ~gkSeqFinishedImpl();
