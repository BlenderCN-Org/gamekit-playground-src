...
#ifndef VEHICLEWHEEL_H_
#define VEHICLEWHEEL_H_

#include <BNodes/out-src/src-gen/Generated/gkGamekit.h>

// gkVehicleWheelImpl

class gkVehicleWheelImpl
		: public gkVehicleWheelAbstract
{
public:
	gkVehicleWheelImpl(gkLogicTree* parent, size_t id, const gkString& name="");
	virtual ~gkVehicleWheelImpl();
