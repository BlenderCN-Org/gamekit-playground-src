...
message(STATUS "Blackberry-Plattform ${BLACKBERRY_ARCHITECTURE}")
...
if ("${ARCH}" STREQUAL "")
	set (ARCH "arm")
	message(STATUS "SET ARCH to arm")
endif()

if (NOT BLACKBERRY_ARCHITECTURE)
	set(BLACKBERRY_ARCHITECTURE "${ARCH}" CACHE STRING "Choose Arch: arm / x86 (only from cli)" FORCE)
	message(STATUS "###Blackberry Arch ${BLACKBERRY_ARCHITECTURE}")
else()
	message(STATUS "###Blackberry Arch ${BLACKBERRY_ARCHITECTURE}")
endif()
...
# Includes
set (BLACKBERRY_SYSTEM_INCLUDE_DIRS )
list( APPEND BLACKBERRY_SYSTEM_INCLUDE_DIRS "${BLACKBERRY_TARGET_ROOT}/qnx6/usr/include" )
include_directories(${BLACKBERRY_SYSTEM_INCLUDE_DIRS})
...
# set( BLACKBERRY_CXX_FLAGS " -V4.6.3,gcc_ntoarmv7le -Y_gpp -D__QNX__" )
 ...
 link_directories($ENV{QNX_TARGET}/armle-v7/usr/lib)
  message(STATUS "LINK DIR-path: $ENV{QNX_TARGET}/armle-v7/usr/lib Arch:${BLACKBERRY_ARCHITECTURE}")
  add_definitions(-DBLACKBERRY_ARM)
  set(BB_ARCH "arm" CACHE STRING "" FORCE)
else()
# set( BLACKBERRY_CC_FLAGS  " -V4.6.3,gcc_ntox86 -D__QNX__" )
# set( BLACKBERRY_CXX_FLAGS " -V4.6.3,gcc_ntox86 -Y_gpp -D__QNX__" )
add_definitions(-DBLACKBERRY_x86)
  set(BB_ARCH "x86" CACHE STRING "" FORCE)

set( BLACKBERRY_CC_FLAGS  " -V4.4.2,gcc_ntox86 -D__QNX__" )
set( BLACKBERRY_CXX_FLAGS " -V4.4.2,gcc_ntox86 -Y_gpp -D__QNX__" )
  link_directories($ENV{QNX_TARGET}/x86/usr/lib)
  message(STATUS "LINK DIR-path: $ENV{QNX_TARGET}/x86/usr/lib Arch:${BLACKBERRY_ARCHITECTURE}")
endif()

message(STATUS "4___###Blackberry Arch ${BLACKBERRY_ARCHITECTURE}")


set( BLACKBERRY 1 )
set( BB_PLAYBOOK 1 )
add_definitions(-D__PLAYBOOK__ -D_LITTLE_ENDIAN)
...
message(STATUS "3___###Blackberry Arch ${BLACKBERRY_ARCHITECTURE}")
...
message(STATUS "2___###Blackberry Arch ${BLACKBERRY_ARCHITECTURE}")
...
message(STATUS "1___###Blackberry Arch ${BLACKBERRY_ARCHITECTURE}")
...
message(STATUS "___###Blackberry Arch ${BLACKBERRY_ARCHITECTURE}")
