...
bpy.types.NodeTree.debugPossibleObjects=bpy.props.CollectionProperty(type=DefaultMap) # save all objects that currently use this tree in debugmode
...
bpy.types.World.gk_validNodeTrees = bpy.props.CollectionProperty(type=DefaultMap)
...
/*endblock:properties*/
    ...
    NEW_IN_SOCKETS = bpy.props.CollectionProperty(type=SocketGroup)
    NEW_OUT_SOCKETS = bpy.props.CollectionProperty(type=SocketGroup)
...
runtimedata.Clazzes.classes[/*name|dq:nodeName*/"nodeName"/*endname*/]=/*name:nodeName*//*endname*/
