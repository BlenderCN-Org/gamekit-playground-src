...
##    if (MINGW)
##        MESSAGE(ERROR "AS")
##        get_target_property(LOC makefbt LOCATION)
##        MESSAGE(STATUS "CROSS LOCATION:${LOC}")
        
        #ADD_EXECUTABLE(makefbt IMPORT)
##        SET_TARGET_PROPERTIES(makefbt PROPERTIES 
##                              LOCATION "/home/tom" )        
##        get_target_property(LOC makefbt LOCATION)
##        MESSAGE(STATUS "AFTER CROSS LOCATION:${LOC}")
##    endif()
##endif()
...
macro(ADD_FBT TARGET)
    ...
    if (CMAKE_CROSSCOMPILING)
        # Create imported target makefbt
        add_executable(makefbt_wine IMPORTED)
        
        # Import target "makefbt" for configuration "Release"
        set_property(TARGET makefbt_wine APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
        set_target_properties(makefbt_wine PROPERTIES
          IMPORTED_LOCATION_RELEASE "${CMAKE_BINARY_DIR}/FileTools/Compiler/wine_makefbt.sh"
          )
        set(FBT_EXECUTABLE makefbt_wine)
    ...
    add_custom_command(
	    ...
	    DEPENDS ${FBT_EXECUTABLE} ${TARNAME} ${SRC_FILES}
	    COMMENT "${BASE_FILES}"
	    )
    set(${TARGET} ${OUTFILE})
endmacro(ADD_FBT)
